...
<li class="active treeview">
          ...
          <ul class="treeview-menu">
             ...
             <li ><a href="chat.php"><i class="fa fa-whatsapp"></i> Chat</a></li>           
            <li class="active"><a href="chatgrub.php"><i class="fa  fa-comments"></i> Chat Grub</a></li>
          </ul>
        </li>


   <li ><a href="materi.php"><i class="glyphicon glyphicon-blackboard"></i> Materi</a></li>         

         

<li ><a href="konseling.php"><i class="fa fa-bell"></i> Konseling</a></li> 
